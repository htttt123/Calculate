...
void jzys_widget::on_btn_add_clicked()              //加法
{
    ...
    {
        bool ok;
        int dec=ui->lineEdit_num1->text().toInt(&ok,10);     //把十进制转化成十进制数
        num1=dec;
    }
    else if(flag1==4)
    {
        bool ok;
        int dec=ui->lineEdit_num1->text().toInt(&ok,16);     //把十六进制转化成十进制数
        num1=dec;
    }
}
